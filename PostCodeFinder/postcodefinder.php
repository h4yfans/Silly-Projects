        ...
        <div class="col-md-6 col-md-offset-3 center whiteBackground">
            ...
            <form>
                <div class="form-group">
                    <input type="text" class="form-control" name="city" id="address" placeholder="Eg. 63 Fake Street, Faketown">
                </div>
            ...
            <div id="fail" class="alert alert-danger center">Could not find postcode for that city. Please try again!</div>
